    ...
    <ns-api-data-block id="ns-pr-data" href="project/${this.project}/volumes">
        <div class="ns-container ns-pr-info">
            ...
            <div class="ns-pr-desc">
                ...
                <div class="ns-pr-desc-utils ns-fs-4 ns-text-black"><span>Lecture : 150 </span>  <span><span class="text-success">180 <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-hand-thumbs-up-fill" viewBox="0 0 16 16">
...
</svg></span> / <span class="text-danger"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-hand-thumbs-down-fill" viewBox="0 0 16 16">
...
</svg> 10</span></span> <span>Publiée par <ns-a>Alice</ns-a></span></div> 
