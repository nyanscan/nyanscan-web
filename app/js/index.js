...
<footer class="w-100 p-0 m-0">
    <div id="ns-footer">
        ...
        <div id="ns-footer-social">
            <a href="/" class="ns-a-clear">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="ns-pict">
            ...
            <a href="/" class="ns-a-clear">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" class="ns-pict">
            ...
            <a href="/" class="ns-a-clear">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="ns-pict">
...
<header class="sticky-top">
    <nav id="ns-nav" class="">
        <div class="ns-nav-part">
            <ns-a href="/"><img class="ns-logo" src="../../res/logo-ns.png" alt="nyanscan-logo"></ns-a>
            <ns-a  class="ns-a-1" href="/forum">Forum</>
        </div>
        ...
        <div class="ns-nav-part">
            ...
            <div id="ns-h-log"></div>
            <img src="${this.app.user.profile_picture}" alt="profil" class="ns-profile-picture">
        </div>
    </nav>
</header>
        `
    ...
    updateLogStatus() {
        ...
        if (this.app.user.isLog) {
            const btn = create('span', null, login, 'ns-a-1');
            btn.addEventListener('click', this.app.user.logout.bind(this.app.user, true));
            btn.innerText = 'Se Déconnecter';
        } else {
            login.innerHTML = "<ns-a class='ns-a-1' id='ns-h-log' href='/auth/login'>Se connecter</ns-a>"
        }
    }
        ...
        <div class="row vh-100">
            <div id="error" class="ns-theme-bg ns-theme-text rounded-3 my-5 align-self-center col-10 offset-1 col-md-8 offset-md-2">
                <div class="ns-center w-100 h-100 flex-row flex-wrap">
                    <div class="w-100 ns-center"><ns-a href="/"><img src="/res/logo-ns.png" alt="nyanscan logo" class="ns-logo"></ns-a></div>
                    ...
                    <div class="w-100 ns-center"><p>Retourner à la <ns-a href="/">page d'accueil</ns-a></p></div>
                </div>
            </div>
        </div>
    </div>
...
class App extends EventTarget {
    ...
    constructor() {
        ...
        this.actualURL = location.pathname.substring(4);
    ...
    async load_module(name) {
        if (this.caches[name] === undefined) {
            const module = await import(`/app/pages/${name}.js`);
