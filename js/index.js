...
class Header extends Component {
        ...
        return `
            <nav id="mainNav" class="navbar navbar-expand-md">
                <div class="container-fluid px-md-5">
                    <!--Logo-->
                    <ns-a href="/" class="navbar-brand ps-2">
                        <img src="../res/logo-ns.png" alt="nyanscan logo" width="38">
                    </ns-a>
                    <!--main Nav Menu-->
                    <div class="collapse navbar-collapse" id="mainNavMenu">
                        <ul class="navbar-nav me-auto mb-2 mb-md-0">
                            <li class="nav-item">
                                <ns-a class="ns-a-1 nav-link" href="#">Catalogue</ns-a>
                            </li>
                            <li class="nav-item">
                                <ns-a class="ns-a-1 nav-link" href="/forum">Forum</ns-a>
                            </li>
                        </ul>
                    </div>
                    <!--Theme switch-->
                    ...
                    <!--Toggle dropdown search bar-->
                    <div class="dropdown">
                        <button onclick="dropSearch() class="">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                            <il>
                                <form id="ns-search" class="justify-content-center form-inline w-75 ms-2">
                    ...
                    <div class="dropdown">
                        <!--Toggle dropdown Profil Nav-->
                        <ns-a class="btn btn-secondary dropdown-toggle" id="dropdownMenuLink" role="button" href="" data-bs-toggle="dropdown" aria-expanded="false">
                            <img src="../res/profile.webp" class="ns-menu-profil img-circle img-responsive" alt="avatar navigation">
                        </ns-a>
                        <ul id="ns-h-log" class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                        
                        </ul>
                    </div>
                    <!--Toggle main Nav Menu-->
                    <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#mainNavMenu" aria-controls="mainNavMenu" aria-expanded="false" aria-label="Toggle Main Menu">
    ...
    updateLogStatus() {
        ...
        if (this.app.user.isLog) {
            login.innerHTML = "<li><ns-a class='ns-a-1 dropdown-item' href='/u/me'>Profil</ns-a></li>";
            const logout = create('li', null, login);
            const btn = create('span', null, logout, 'ns-a-1', 'dropdown-item');
            btn.addEventListener('click', this.app.user.logout.bind(this.app.user, true));
            btn.innerText = 'Se Déconnecter';

        } else {
            login.innerHTML = "<li'><ns-a class='ns-a-1 dropdown-item' href='/auth'>Se Connecter</ns-a></li>"
        }
    }
